  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 slide-up">
        <div>
          <h1 className={`text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 text-gray-900 dark:text-white`}>Fun</h1>
          <p className={`text-sm sm:text-base text-gray-700 dark:text-gray-300`}>Track your fun transactions with ease</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
        <div className="stat-card bounce-in p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className={`text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300`}>Total Income</p>
        ...
        <div className="stat-card bounce-in p-4 sm:p-6" style={{animationDelay: '0.1s'}}>
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className={`text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300`}>Total Expenses</p>
        ...
        <div className="stat-card bounce-in p-4 sm:p-6" style={{animationDelay: '0.2s'}}>
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className={`text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300`}>Balance</p>
